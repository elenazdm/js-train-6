...
function printKeysAndValues(obj) {
  ...
  for (const key in country) // Виводимо ключ та значення на консоль
...
function changeRole(array, newRole) {
  ...
  console.log(userList)// Змінюємо роль кожного користувача на нове ім'я
...
function compareObjects(obj1, obj2) {
  ...
  for (let planet1 in obj1)
    for (let planet2 in obj2)
      if (planet1[obj1] === planet2[obj2]) return true;
  return false;
